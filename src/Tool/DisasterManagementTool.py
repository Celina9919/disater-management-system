...
class DisasterManagementTool:
    ...
    def display_city_map(self):
        ...
        # Initialize the appropriate NetworkX graph (directed or undirected)
        ...
        # Create the figure for displaying the graph
        plt.figure(figsize=(8, 6), num=self.graph_type) # Set figure size and graph title
    

        # Draw the graph with optional edge labels if weighted
