...
In this function:
Node D: Evacuation Point - Source Node
Nodes A, B, C, H, I: Shelters -Sink Points
"""
...
def visualize_evacuation_flow(graph, flow_dict, title="Evacuation Flow Visualization"):
    ...
    nx.draw_networkx_nodes(graph, pos, node_size=600, node_color="rosybrown")
...
Shelter H: 40 people (DH + EH + FH + GH = 20 + 4 + 7 + 9)
Shelter I: 20 people
Maximum Flow = 150 + 130 + 200 + 40 + 20 = 540 (The infrastructure is sufficient for maximum 540 people in this case)

Hence, with the evacuation need from source D: 300 people, the city infrastructure is sufficient for evacuation.
...
The Total Time Complexity: O(V * E * E)
