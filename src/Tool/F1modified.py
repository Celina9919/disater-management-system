...
# Adjacency Matrix for Schilda City
data = {
    'A': [0, 20, 5, 7, 7, 15, 25, 6, 23],
    'B': [20, 0, 34, 25, 15, 10, 4, 7, 16],
    'C': [5, 34, 0, 20, 27, 10, 8, 12, 15],
    'D': [7, 25, 20, 0, 3, 8, 9, 20, 7],
    'E': [7, 15, 27, 3, 0, 27, 23, 25, 0],
    'F': [15, 10, 10, 8, 27, 0, 3, 7, 21],
    'G': [25, 4, 8, 9, 23, 3, 0, 17, 6],
    'H': [6, 7, 12, 20, 25, 7, 17, 0, 30],
    'I': [23, 16, 15, 7, 5, 21, 6, 30, 0]
}

# Convert the adjacency matrix into a pandas DataFrame
